...
<style style="scss">
	@keyframes candlemove {
		...
		9%  {
				background: url(../../static/canvas/candle/lazhu0006.png) no-repeat center; background-size: contain;
				-webkit-transform: translate3d(0, 0, 0);
				-moz-transform: translate3d(0, 0, 0);
				-ms-transform: translate3d(0, 0, 0);
				-o-transform: translate3d(0, 0, 0);
		...
		10.8%  {
				background: url(../../static/canvas/candle/lazhu0005.png) no-repeat center; background-size: contain;
				-webkit-transform: translate3d(0, 0, 0);
				-moz-transform: translate3d(0, 0, 0);
				-ms-transform: translate3d(0, 0, 0);
				-o-transform: translate3d(0, 0, 0);
